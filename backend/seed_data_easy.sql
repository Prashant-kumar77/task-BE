-- Easy Seed Data for LearnLynk
-- Instructions:
-- 1. First, create users in Supabase Auth (Authentication > Users)
-- 2. Get their IDs by running: SELECT id, email FROM auth.users;
...
-- ============================================
-- Get your user IDs from: SELECT id, email FROM auth.users;
-- Generate a tenant UUID or use: SELECT gen_random_uuid();

-- Example (replace with your values):
-- \set tenant_id '123e4567-e89b-12d3-a456-426614174000'
-- \set admin_user_id '123e4567-e89b-12d3-a456-426614174001'
-- \set counselor_user_id '123e4567-e89b-12d3-a456-426614174002'

-- For Supabase SQL Editor, use this format instead:
DO $$
DECLARE
...
BEGIN
  ...
  RETURNING id INTO v_team1_id, v_team2_id;
  ...
  RAISE NOTICE 'Created: Teams, Users, Leads, Applications, and Tasks';
END $$;
